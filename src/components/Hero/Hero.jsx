...
const Hero = () => {
    return (
        <div className="">                       
            <div className="bg-[url('https://i.ibb.co/DC0Mh5y/Food-Presentation-Templatse.png')] w-screen h-screen text-white bg-cover bg-no-repeat">
            <div className=" bg-gradient-to-b b from-black/90 w-full h-screen z-0 backdrop-blur-sm">
            <Navbar></Navbar>
            <div className="absolute bottom-14 translate-left-1/2 lg:left-10 right-0 text-center px-5">

                ...
                <h1 className="myHeading" data-aos='zoom-in-down'>Add Food</h1>
                    ...
                    <form onSubmit={handleAddProduct} className="my-10">
                        <div className="grid gap-10 sm:grid-cols-2">
                            ...
                            <div className="relative z-0">
                                <input type="text" name="foodStatus" required defaultValue='Available' className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-base text-gray-900 focus:border-red-600 focus:outline-none focus:ring-0"/>

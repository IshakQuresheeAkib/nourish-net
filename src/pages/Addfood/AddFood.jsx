...
const AddFood = () => {
    ...
    const handleAddProduct = e => {
        ...
        const food = {foodName,foodImage,foodQuantity,donatorEmail,donatorImage,donatorName,pickupLocation,expiredDateTime,additionalNotes,foodStatus}
        console.log(food);

        axios.post('http://localhost:5000/available-foods',food)
        .then(data=>{
                    ...
                    <form onSubmit={handleAddProduct} className="my-10">
                        <div className="grid gap-10 sm:grid-cols-2">
                            <div className="relative z-0 mb-5">
                                <input type="text" name="foodName" className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-base text-gray-900 focus:border-red-600 focus:outline-none focus:ring-0"/>
                            ...
                            <div className="relative z-0 mb-5">
                                <input type="number" name="foodQuantity" className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-base text-gray-900 focus:border-red-600 focus:outline-none focus:ring-0"/>
                            ...
                            <div className="relative z-0">
                                <input type="text" name="donatorEmail" defaultValue={user?.email} className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-base text-gray-900 focus:border-red-600 focus:outline-none focus:ring-0"/>
                                <label className="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm font-bold text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-red-600 peer-focus:dark:text-red-600">Donator Email</label>                               
                            </div>
                            <div className="relative z-0 mb-5">
                                <input type="text" name="donatorName" defaultValue={user?.displayName} className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-base text-gray-900 focus:border-red-600 focus:outline-none focus:ring-0"/>
                                <label className="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm font-bold text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-red-600 peer-focus:dark:text-red-600">Donator Name</label>                               
                            </div>
                            <div className="relative z-0">
                                <input type="text" name="foodStatus" defaultValue='available' className="peer block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-base text-gray-900 focus:border-red-600 focus:outline-none focus:ring-0"/>
